...
<div class="page page-home">
    ...
    <div class="page-main">
        ...
        <section class="section-3">
            <div class="learning-path pb-5 pt-5">
                <div class="container">
                    <div class="text-center fs-medium" style="padding-bottom: 5px;font-size: 22px; color: #858DA8">Lộ trình
                    </div>
                    <div class="line-bg-green mt-1 m-auto pad"></div>
                    <h2 class="section-title text-center mb-2">HỌC TẬP TẠI DINOTECH</h2>
                    <img class="thumbnail-img" src="{{URL::asset('/images/10d6af7f-ff88-4a2c-acdf-ce16ae4a0a50.jpeg')}}" alt="">
                </div>
            </div>
        </section>
        <section class="section-4">
            <div class="w-100 trainning">
                <div class="w-100 bg-top">
                    <img class="w-100" src="{{URL::asset('/images/training.png')}}" alt="">
                </div>
                <div class="container">
                    <div class="text-center fs-medium c-white" style="padding-bottom: 5px;font-size: 22px">Phương pháp</div>
                    <div class="line-bg-green mt-1 m-auto pad"></div>
                    <h4 class="title text-center fs-large fw-700 c-white mt-4">ĐÀO TẠO ĐỘC QUYỀN</h4>
                    <div class="text-center fs-small-2 fw-400 c-white"> ILP khơi nguồn cảm hứng sáng tạo của thế hệ trẻ
                    </div>
                    <div class="row circle-ilp">
                        <div class="col-md-4 col-4 col-sm-4 pl-4 trainning-item-div">
                            <div class="trainning-item-content" onclick="hoverItem(this)" id="trainning-item-i">
                                <div class="">I</div>
                                <div class="pad-top-10">Inspiration</div>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 col-sm-4 pl-4 trainning-item-div">
                            <div class="trainning-item-content" onclick="hoverItem(this)" id="trainning-item-l">
                                <div class="">L</div>
                                <div class="pad-top-10">Logic</div>
                            </div>
                        </div>
                        <div class="col-md-4 col-4 col-sm-4 pl-4 trainning-item-div">
                            <div class="trainning-item-content" onclick="hoverItem(this)" id="trainning-item-p">
                                <div class="">P</div>
                                <div class="pad-top-10">Practice</div>
                            </div>
                        </div>
                    </div>
                    <div class="row arrow">
                        <div class="col-md-4 col-sm-4 col-4 mx-auto text-center arrow-inspiration">
                            <img height="50%" class="w-150 m-bot-140" src="{{URL::asset('/images/triangle-arrow-top-vector-ui-512-removebg-preview.png')}}" alt="">
                        </div>
